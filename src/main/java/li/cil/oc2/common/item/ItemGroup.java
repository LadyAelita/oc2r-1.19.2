...
public final class ItemGroup {
    public static final CreativeModeTab COMMON_TAB = new CreativeModeTab(API.MOD_ID + ".common") {
    ...
    // public static final RegistryObject<CreativeModeTab> _COMMON_TAB = TAB_REGISTER.register("common", () -> CreativeModeTab.builder()
